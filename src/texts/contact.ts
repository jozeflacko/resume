const contact = [
  ...
  { label:'GitHub ', icon:"github", value:'opam', link:'https://github.com/opam'},
  //{ label:'Facebook', icon:'facebook', value:'jozef.lacko.33', link:'https://www.facebook.com/jozef.lacko.33' },
];
